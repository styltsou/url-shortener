...
function LinksPage() {
  ...
  const handleShorten = async (originalUrl: string, customCode?: string, expirationDate?: string) => {
    ...
    return (
      <main className="py-12 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center py-20">
          <h2 className="text-2xl font-bold mb-4 text-destructive">Error loading links</h2>
          ...
          <div className="space-y-2">
            ...
            {urls.length === 0 && (
              <div className="text-center py-20 bg-card rounded-3xl border border-border">
                ...
                <p className="text-muted-foreground">Create your first shortened link above.</p>
              </div>
            )}
          </div>
        )}
